/*! kist-fauxanchor 0.5.3 - Simulate default anchor action. | Author: Ivan Nikolić <niksy5@gmail.com> (http://ivannikolic.com/), 2017 | License: MIT */
...
function stopEntryAction ( event, key, e ) {
	...
	if ( event === 'mousedown' ) {
		...
		if ( (ielte8 && touch) || (blink && key === 2 && !touch) ) {
			state--;
		}
	}
